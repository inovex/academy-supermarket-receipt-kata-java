...
public class ShoppingCart {
    ...
    private final List<PQ> items = new ArrayList<>();
    ...
    public void addItemQuantity(Product product, double quantity) {
        items.add(new PQ(product, quantity));
            ...
            if (offers.containsKey(p)) {
                ...
                if (offer.offerType == SpecialOfferType.THREE_FOR_TWO) {
                    ...
                    if (quantityAsInt >= 2) {
                        ...
                        discount = new DisC(p, "2 for " + offer.argument, -discountN);
                    }
                ...
                if (offer.offerType == SpecialOfferType.TEN_PERCENT_DISCOUNT) {
                    discount = new DisC(p, offer.argument + "% off", -quantity * unitPrice * offer.argument / 100.0);
                }
                if (offer.offerType == SpecialOfferType.FIVE_FOR_AMOUNT && quantityAsInt >= 5) {
                    ...
                    discount = new DisC(p, x + " for " + offer.argument, -discountTotal);
                }
                if (discount != null)
